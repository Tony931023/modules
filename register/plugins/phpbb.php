...
class Phpbb extends Plugin
{
	...
	private function process()
	{
		...
		$this->db->query("INSERT INTO ".$this->CI->config->item('forum_table_prefix')."users(`username`, `user_password`, `user_email`, `username_clean`, `user_regdate`, `group_id`,`user_permissions`,`user_sig`) VALUES(?, ?, ?, ?, ?,'2','','<t></t>')", array($this->username, $password, $this->email, $this->username, time()));
